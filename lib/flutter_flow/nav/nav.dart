      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'Main_bookedList',
              path: 'mainBookedList',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Main_bookedList')
                  : MainBookedListWidget(),
            ),
            FFRoute(
              name: 'Main_Contracts',
              path: 'mainContracts',
            ...
            FFRoute(
              ...
              path: 'projectDetails',
              asyncParams: {
                'calendar': getDoc(['calendar'], CalendarRecord.fromSnapshot),
                'venture': getDoc(['venture'], VentureRecord.fromSnapshot),
              },
              builder: (context, params) => ProjectDetailsWidget(
                calendar: params.getParam('calendar', ParamType.Document),
                venture: params.getParam('venture', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'searchPage',
            ...
            FFRoute(
              name: 'Main_workersList',
              path: 'mainWorkersList',
              builder: (context, params) => MainWorkersListWidget(),
            ),
            FFRoute(
              name: 'Main_Message',
              path: 'mainMessage',
              builder: (context, params) => MainMessageWidget(),
            ),
            FFRoute(
              name: 'projectDetailsCopy',
              path: 'projectDetailsCopy',
              asyncParams: {
                'calendar': getDoc(['calendar'], CalendarRecord.fromSnapshot),
                'venture': getDoc(['venture'], VentureRecord.fromSnapshot),
              },
              builder: (context, params) => ProjectDetailsCopyWidget(
                calendar: params.getParam('calendar', ParamType.Document),
                venture: params.getParam('venture', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'Main_Jornada',
              path: 'mainJornada',
              builder: (context, params) => MainJornadaWidget(),
            ),
            FFRoute(
              name: 'Main_WorkedbookedList',
              path: 'mainWorkedBookedList',
              builder: (context, params) => MainWorkedbookedListWidget(),
            ),
            FFRoute(
              name: 'Main_Calendar',
              path: 'mainCalendar',
