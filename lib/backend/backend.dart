...
import 'schema/venture_record.dart';
import 'schema/category_record.dart';
import 'schema/regions_record.dart';
import 'schema/social_record.dart';
import 'schema/services_record.dart';
import 'schema/persona_service_record.dart';
...
export 'schema/venture_record.dart';
export 'schema/category_record.dart';
export 'schema/regions_record.dart';
export 'schema/social_record.dart';
export 'schema/services_record.dart';
export 'schema/persona_service_record.dart';
...
/// Functions to query VentureRecords (as a Stream and as a Future).
Future<int> queryVentureRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VentureRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VentureRecord>> queryVentureRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      VentureRecord.collection,
      VentureRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VentureRecord>> queryVentureRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query SocialRecords (as a Stream and as a Future).
Future<int> querySocialRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SocialRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SocialRecord>> querySocialRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SocialRecord.collection,
      SocialRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SocialRecord>> querySocialRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query PersonaServiceRecords (as a Stream and as a Future).
Future<int> queryPersonaServiceRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PersonaServiceRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PersonaServiceRecord>> queryPersonaServiceRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PersonaServiceRecord.collection,
      PersonaServiceRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PersonaServiceRecord>> queryPersonaServiceRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
