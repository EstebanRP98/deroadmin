                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'MAIN_PROFILE_arrow_back_sharp_ICN_ON_TAP');
                                        context.safePop();
                                      },
                                    ),
                                    Padding(
                            ...
                            Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'fyxsf6vn' /* Configuración de la cuenta */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                  ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'MAIN_PROFILE_CERRAR_SESION_BTN_ON_TAP');
