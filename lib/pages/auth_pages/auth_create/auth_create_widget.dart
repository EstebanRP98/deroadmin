                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '59g0bt96' /* Llena el formulario de aca par... */,
                            ),
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'seheok8a' /* Correo Electronico */,
                                    ),
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      '0uknk55c' /* Ingrese su correo aqui */,
                                    ),
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: FFLocalizations.of(context).getText(
                                  'kx2trk1o' /* Confirma contraseña */,
                                ),
                                labelStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                                hintText: FFLocalizations.of(context).getText(
                                  'k8c3y3u7' /* Repite la contraseña... */,
                                ),
                                hintStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                                enabledBorder: OutlineInputBorder(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              AutoSizeText(
                                FFLocalizations.of(context).getText(
                                  '07gxzzhq' /* Usa una red social para contin... */,
                                ),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'AUTH_CREATE_PAGE_INGRESAR_BTN_ON_TAP');
